...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> STORAGE_CONDUIT = registerBlock("storage_conduit", () -> new StorageConduitBlock(BlockBehaviour.Properties.of()));
    public static final DeferredBlock<Block> STORAGE_CONDUIT_EXTENSION = registerBlock("storage_conduit_extension", () -> new StorageConduitExtensionBlock(BlockBehaviour.Properties.of()));
